      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-xs font-medium text-red-700 dark:text-error-400">
              upload failed, pelase tray again.
            </span>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-xs font-medium dark:text-zinc-100">
              {name}
            </span>
