...
type InputPrefixProsp = ComponentProps<'div'>
type InputControlProsp = ComponentProps<'input'>
type InputRootProps = ComponentProps<'div'>

export function Prefix(props: InputPrefixProsp) {
  return <div {...props} />
}

export function Control(props: InputControlProsp) {
  return (
    <input
      type="text"
